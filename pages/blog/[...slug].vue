        ...
        <article class="prose text-typography_primary_light dark:text-typography_primary_dark">
            <Section id="blog-title">
                ...
                >
                    ...
                    <span class="font-light text-typography_primary_light/75 dark:text-typography_primary_dark/75">{{
                ...
                <div
                    class="border-b-2 pb-8 border-typography_primary_light dark:border-typography_primary_dark flex flex-col md:flex-row items-center md:justify-between"
                >
...
const { data } = await useAsyncData(`content-${path}`, async () => {
    ...
    let surround = queryContent().only(['_path', 'headline', 'excerpt']).sort({ publishDate: -1 }).findSurround(path);
    return {
    ...
    script: [
        {
            ...
            children: JSON.stringify({
                ...
                datePublished: data.value.article.publishDate,
                dateModified: data.value.article.publishDate,
